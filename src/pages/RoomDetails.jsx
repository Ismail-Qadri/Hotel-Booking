...
<div className="flex flex-col lg:flex-row mt-6 gap-6">
  ...
  <div className="w-full lg:w-3/5">
    <img
      src={mainImage}
      alt=""
      className="w-full h-[400px] sm:h-[400px] rounded-xl shadow-lg object-cover"
    />
  </div>
      ...
      room.images.map((image, index) => (
        <img
          ...
          className={`w-full rounded-xl shadow-md object-cover cursor-pointer
            ${mainImage === image ? 'outline-3 outline-orange-500 scale-105' : ''}`}
        />
      ))}
  </div>
</div>
...
<div className="flex flex-col md:flex-row md:justify-between mt-10">
    <div className="flex flex-col">
        ...
        <div className="flex flex-wrap items-center mt-3 mb-6 gap-8">
    ...
    <div>
      ...
      <div className="flex flex-col items-start gap-4">
        <div className="flex gap-4">
          ...
          <div>
            <p className="text-lg md:text-xl"> Hoisted by {room.hotel.name}</p>

...
const LandingPage = () => {
  return (
    ...
    >
      ...
      <h1 className="font-playfair text-2x1 md:text-5xl md:text-[56px] font-bold md:font-extrabold max-w-xl mt-4">
        Discover Your Perfect Gateway Destination{" "}
      </h1>
      <p className="max-w-130 mt-2 text-sm md:text-base">
        Unparalleled luxury and comfort await at worlds's most exclusive hotels
